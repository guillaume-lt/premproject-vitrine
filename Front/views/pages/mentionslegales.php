    	...
    	<div class="content">
    		<div class="row">
    			<div class="col-md-12 mt_lg">
    				<h2 class="section_title">1 - Informations légales</h2>
    				<p>
					...
					<p>
						<b>Le site PremProject est édité par :</b><br />
						Pour le web, dont le siège siège social est situé à l'adresse suivante : rue Bonneterie, 84000 Avignon, et immatriculée au N° de SIRET : 803 812 098 00017 11.
						<br />
						Téléphone : 06 66 22 24 77 / Adresse e-mail : contact@premproject.com.
						<br />
						<b>Le directeur de publication du site est :</b><br />
						M Hernan Carricaburu.
					</p>
					<p>
						<b>Le site PremProject est hébergé par :</b><br />
						OVH – SAS au capital de 5 000 000 € RCS Roubaix – Tourcoing 424 761 419 00045 Code APE 6202A – N° TVA : FR 22 424 761 419 
						<br />
				...
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">3 - Contact</h2>
					<p>
						Pour toute question ou demande d'information concernant le site, ou tout signalement de contenu ou d'activités illicites, l'utilisateur peut contacter l'éditeur à l'adresse e-mail suivante: contact@premproject.com ou adresser un courrier recommandé avec accusé de réception à : Pour le web - rue Bonneterie, 84000 Avignon.
					</p>
				</div>

				<div class="col-md-12 mt_lg">
					<h2 class="section_title">4 - Acceptation des conditions d'utilisations</h2>
					<p>
				...
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">5 - Accès et navigation</h2>
					<p>
					...
					<p>
						La connexion et la navigation sur le site PremProject valent acceptation sans réserve des présentes Conditions Générales d'Utilisation, quelques soient les moyens techniques d'accès et les terminaux utilisés.
					</p>
					<p>
				...
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">6 - Gestion du site</h2>
					<p>
				...
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">7 - Service reservés aux utilisateurs inscrits</h2>
					<p>
						7.1 INSCRIPTION
					</p>
					<p>
					...
					<p>
						L'inscription et l'accès aux services du site sont réservés exclusivement aux personnes physiques capables juridiquement, ayant rempli et validé le formulaire d'inscription disponible en ligne sur le site PremProject, ainsi que les présentes Conditions Générales d'Utilisation.
					</p>
					<p>
					...
					<p>
						Toute communication réalisée par PremProject et ses partenaires est en conséquence réputée avoir été réceptionnée et lue par l'utilisateur. Ce dernier s'engage donc à consulter régulièrement les messages reçus sur cette adresse e-mail et à répondre dans un délai raisonnable si cela est nécessaire.
					</p>
					<p>
					...
					<p>
						PremProject se réserve en tout état de cause la possibilité de refuser une demande d'inscription aux services en cas de non-respect par l'Utilisateur des dispositions des présentes Conditions Générales d'Utilisation.
					</p>
					<p>
						7.1 DÉSINSCRIPTION
					</p>
				...
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">8 - Responsabilités</h2>
					<p>
				...
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">9 - Liens hypertextes</h2>
					<p>
						Le site peut contenir des liens hypertextes pointant vers d'autres sites internet sur lesquels PremProject n'exerce pas de contrôle. Malgré les vérifications préalables et régulières réalisés par l'éditeur, celui-ci décline tout responsabilité quant aux contenus qu'il est possible de trouver sur ces sites.
					</p>
					<p>
					...
					<p>
						Enfin, PremProject se réserve le droit de faire supprimer à tout moment un lien hypertexte pointant vers son site, si le site l'estime non conforme à sa politique éditoriale.
					</p>
				</div>
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">10 - Collecte de données</h2>
					<p>
						Le site est déclaré à la Commission Nationale Informatique et Libertés (CNIL) sous le numéro 1896307.
					</p>
					<p>
					...
					<p>
						Pour faire usage de l'un des droits précités, l'utilisateur doit s'adresser à l'éditeur en le contactant par e-mail à l'adresse suivante : contact@premproject.com, ou par courrier recommandé adressé au siège social de l'éditeur en précisant ses nom, prénom(s), adresse et adresse(s) e-mail.
					</p>
				</div>
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">11 - Cookies</h2>
					<p>
				...
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">12 - Propriété intellectuelle</h2>
					<p>
				...
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">13 - Loi applicable et juridiction compétente</h2>
					<p>
