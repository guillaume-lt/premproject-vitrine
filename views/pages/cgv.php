    	...
    	<div class="content">
    		<div class="row">
    			<div class="col-md-12 mt_lg">
    				<h2 class="section_title">Préambule</h2>
    				<p>
    					Le site est édité par le vendeur, Pour le web, dont le siège social est situé à l'adresse suivante : rue Bonneterie, 84000 Avignon, et immatriculée au N° de SIRET : 803 812 098 00017 11.
					</p>
					<p>
						Le vendeur n'est pas assujetti à la TVA en vertu de l'article article 293 B du CGI.
					</p>
					<p>
						Les dispositions suivantes ont pour objet de définir les conditions générales de vente sur le site PremProject.
					</p>
					<p>
				...
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">1 - Catalogue ou boutique en ligne</h2>
					<p>
				...
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">2 - Prix</h2>
					<p>
				...
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">3 - Commande en ligne</h2>
					<p>
				...
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">4 - Confirmation et paiement de la commande</h2>
					<p>
					...
					<p>
						Pour toute question relative à la commande, le client pourra contacter le service client aux coordonnées suivantes :  contact@premproject.com
					</p>
				</div>

				<div class="col-md-12 mt_lg">
					<h2 class="section_title">5 - Signature électronique</h2>
					<p>
						Conformément aux disposition de la Loi n° 2000-230 du 13 mars 2000, la fourniture en ligne du numéro de carte bancaire de l'acheteur et la validation finale de la commande valent preuve de l'accord du client, de l'exigibilité des sommes dues au titre du bon de commande, signature et acceptation expresse de toutes les opérations effectuées.
					</p>
				</div>

				<div class="col-md-12 mt_lg">
					<h2 class="section_title">6 - Preuve de la transaction</h2>
					<p>
				...
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">7 - Mode de paiement</h2>
					<p>
				...
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">8 - Droit de rétraction</h2>
					<p>
				...
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">9 - Protection des données</h2>
					<p>
					...
					<p>
						Le vendeur a fait à cet effet une déclaration à la CNIL sous le numéro 1896307.
					</p>
					<p>
						Le client a un droit d'accès, de modification et de suppression des informations collectées, notamment en s'adressant à cet effet au service client.
					</p>
				</div>
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">10 - Force Majeure</h2>
					<p>
				...
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">11 - Nullité partielle</h2>
					<p>
				...
				<div class="col-md-12 mt_lg">
					<h2 class="section_title">12 - Loi applicable et juridiction compétente</h2>
					<p>
